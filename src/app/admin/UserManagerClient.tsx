                                ...
                                <>
                                    <td>
                                        <TextInput
                                            ...
                                            onChange={(e) =>
                                                editForm.setValues({ ...editForm.values, user: e.target.value })
                                            }
                                        />
                                    </td>
                                    <td>
                                        <SelectInput
                                            ...
                                            onChange={(e) =>
                                                editForm.setValues({ ...editForm.values, authority: e.target.value })
                                            }
                                        >
                                            <option value={AUTHORITY.user}>{LA.user}</option>
                                            <option value={AUTHORITY.admin}>{LA.admin}</option>
                                    ...
                                    <td className="task-table__actions">
                                        <TextInput
                                            ...
                                            onChange={(e) =>
                                                editForm.setValues({ ...editForm.values, pin: e.target.value })
                                            }
                                            style={{ width: "160px" }}
                                        />
                                        <Button
                                            variant="approve"
                                            disabled={isLoading}
                                            onClick={() => editForm.onUpdate(u.id)}
                                        >
                                            {C.save}
                                        </Button>
                                        <Button variant="logout" onClick={() => editForm.setId(null)}>
                                            {C.cancel}
                                        </Button>
                                    </td>
                                </>
