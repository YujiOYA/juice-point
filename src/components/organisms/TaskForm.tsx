...
export default function TaskForm({ user, initialTasks, initialSubmissions, initialRewards }: Props) {
    ...
    const { data, taskForm, requestForm, isSubmitting, isRequesting, handleUsePoints } = useTaskForm(
        user,
        initialTasks,
        initialSubmissions,
        initialRewards,
                    ...
                    >
                        <span
                            style={{
                                ...
                                transform: pendingOpen ? "rotate(90deg)" : "rotate(0deg)",
                            }}
                        >
                            ▶
                        </span>
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        style={{
                                            ...
                                            background: "none",
                                            border: "none",
                                            cursor: remindedIds.has(s.id) ? "default" : "pointer",
                                            fontSize: "1rem",
                                            opacity: remindedIds.has(s.id) ? 0.4 : 1,
                                        }}
                                    >
            ...
            <FormField label={L.labelRequestPoint} htmlFor="requestPoint">
                <TextInput
                    ...
                    onBlur={(e) => {
                        ...
                        if (!isNaN(v)) setRequestPoint(String(v));
                    }}
            ...
            {pendingRequest.length > 0 && (
                <div style={{ marginTop: "1.5rem", borderTop: "1px solid #e5e7eb", paddingTop: "1rem" }}>
                    ...
                    >
                        <span
                            style={{
                                display: "inline-block",
                                transition: "transform 0.2s",
                                transform: pendingRequestOpen ? "rotate(90deg)" : "rotate(0deg)",
                            }}
                        >
                            ▶
                        </span>
                    ...
                    <div
                        style={{
                            overflow: "hidden",
                            maxHeight: pendingRequestOpen ? "500px" : "0",
                            transition: "max-height 0.3s ease",
                        }}
                    >
                        <ul
