...
export default function AdminTable({ columns, sortKey, sortDir, sortKey2, sortDir2, onSort, onSort2, children }: Props) {
      ...
      <thead>
        <tr>
          {columns.map((col) => (
            <th
              key={col.key}
              onClick={col.sortable && onSort ? (e) => e.shiftKey ? onSort2?.(col.key) : onSort(col.key) : undefined}
